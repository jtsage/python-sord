...
class rdi():
	...
	def prompt(self):
		...
		thismenu += "  \x1b[32mYour command, \x1b[1m" + self.user.thisFullname + "\x1b[22m? \x1b[1;37m[\x1b[22m"+ptime+"\x1b[1m] \x1b[0m\x1b[32m:-: \x1b[0m"
		return thismenu
	...
	def flirt_seth(self):
		...
		while ( not thisQuit ):
			...
			if not key: break
				...
				pass
		if ( thisTry ):
			user.write("\r\n  \x1b[32m"+data.fresult[1][thisRun][2]+"\x1b[0m\r\n")
			time.sleep(1)
			user.write("\r\n  \x1b[1;37m...")
			time.sleep(1)
			...
			if ( user.charm > data.fresult[2][thisRun][0] ):
				...
				if ( thisScrew ):
					user.fuck += 1
				user.write("\r\n  \x1b[1;34m"+data.fresult[2][thisRun][3]+"\x1b[0m\r\n  \x1b[32mYou gain \x1b[1m"+str(thisExp)+"\x1b[22m experience.\x1b[0m\r\n")
			else:
				thisScrew = False
				user.write("\r\n  \x1b[1;31m"+data.fresult[2][thisRun][4]+"\x1b[0m\r\n")
	...
	def flirt_violet(self):
		...
		if ( thisTry ):
			...
			if ( user.charm > data.fresult[1][thisRun][0] ):
				...
				if ( thisScrew ):
					user.fuck += 1
				user.write("\r\n  \x1b[1;34m"+data.fresult[1][thisRun][3]+"\x1b[0m\r\n  \x1b[32mYou gain \x1b[1m"+str(thisExp)+"\x1b[22m experience.\x1b[0m\r\n")
			else:
				thisScrew = False
				user.write("\r\n  \x1b[1;31m"+data.fresult[1][thisRun][4]+"\x1b[0m\r\n")
